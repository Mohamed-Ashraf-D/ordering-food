...
<link href="https://fonts.googleapis.com/css2?family=El+Messiri&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        .modal-backdrop {
            display:none;
            position: fixed; /* Ensure the backdrop covers the entire viewport */
            right: 0;
            bottom: 0;
            left: 0;
            background-color: rgba(0, 0, 0, 0.5); /* Semi-transparent black color for the overlay */
            z-index: 1050; /* Ensure the overlay is above other content */
        }
        .modal{
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php"><b>العروض </b> <span class="sr-only"></span></a> </li>
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>ماذا تريد أن تطلب اليوم؟
 </h1>
                    <h5 class="font-white space-xs">مرحباً</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">ابحث عن المنطقة او القرية او الشارع</label>
                                <div class="form-group">

<a href="#" data-toggle="modal" data-target="#mapModal"> <img src="images/87.png"   src="images/87.png" width="45" height="45" alt="Mastercard" >
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="....اختر عنوانك او شارعك"> </div>
                            </div>
                            <button onclick="location.href='restaurants.php'" type="button" class="btn theme-btn btn-lg"> أختر موقعك وتابع</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span> اولاً اختر وجهتك</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>اطلب طلبك</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>وهيوصلك لحد بيتك</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2> اللي بخاطرك، واصلك</h2>
                    <p class="lead">اطلب توصيل الطعام والبقالة والاحتياجات الصحية  أونلاين . اكتشف آلاف المطاعم والمتاجر والصيدليات القريبة إليك.</p>

                    <a href="#"> <img src="images/order.png" alt="order"> </a>
                ...
                <div class="row">
						...
						$query_res= mysqli_query($db,"select * from categories LIMIT 3");
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																<h5><a href="stores.php?c_id='.$r['c_id'].'">'.$r['c_name'].'</a></h5>
																<div class="product-name">'.$r['c_name'].'</div>
																<div </span> <a href="stores.php?c_id='.$r['c_id'].'" class="btn theme-btn-dash pull-right">أُطلب الأن</a> </div>
															</div>
       ...
       <!-- <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>اشتر كل  طلبات البيت  في 3 خطوات </h2>
                   ...
                   <!-- <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>اختر المتجر او المطعم او الصيدلية </h3>
                                    <p>لدينا قوائم  من أكثر من 500 مطعم و متجر و صيدلية توصيل عبر الإنترنت.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>اختر طلبك</h3>
                                <p>بإمكانك الأن الطلب من اكثر من 500 متجر ومطعم ومتطالباتك الصحية </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3> وطلبك هيوصلك في  المعاد </h3>
                                <p>احصل على  ما تحتاجه وقت ما تحتاجه </p>
                            </div>
                        </div>
                    </div>
                </div> -->
                    ...
                    <div class="restaurant-listing">
						...
						$ress= mysqli_query($db,"select * from stores");
									      while($rows=mysqli_fetch_array($ress))
										  {
													...
													$query= mysqli_query($db,"select * from categories where c_id='".$rows['category_id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="products.php?store_id='.$rows['store_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="products.php?store_id='.$rows['store_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button class="btn btn-secondary" id="getLocationBtn">Get Location</button>
...
<script>
    ...
    function initMap() {
        map = new google.maps.Map(document.getElementById("map"), {
         ...
         // Replace 'marker' with your marker object if needed
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBGRg_paOQhrzKEx5a5ybaWzeASQcBwhFk&libraries=places&callback=initMap"></script>
