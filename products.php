...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="products.php?store_id=<?php echo $_GET['store_id']; ?>">Pick Your favorite food</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from stores where store_id='$_GET[store_id]' ");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/2.jpeg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    <h6><b><a href="#"><?php echo $rows['title']; ?></a></b></h6>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["title"]; ?><a href="products.php?store_id=<?php echo $_GET['store_id']; ?>&action=remove&id=<?php echo $item["p_id"]; ?>" >
...
?>								  
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        ...
                                        <p>Free Shipping</p>
                                        <a href="checkout.php?res_id=<?php echo $_GET['store_id'];?>&action=check"  class="btn theme-btn btn-lg">تنفيذ الطلب</a>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
						...
						<?php  // display values and item of food/dishes
									$stmt = $db->prepare("select * from products where store_id='$_GET[store_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='products.php?store_id=<?php echo $_GET['store_id'];?>&action=add&id=<?php echo $product['p_id']; ?>'>
										...
										<span class="price pull-left" >$<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="اضف الى السلة" />
										</div>
										</form>
                                    </div>
                                    <!-- end:row -->
            ...
            <footer class="footer">
                <div class="container">
                    ...
                    <div class="row top-footer">
                        ...
                        <a href="#"> <img src="images\25.png" height="75px" width="150px" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
