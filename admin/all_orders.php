...
<!-- Page wrapper  -->
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <footer class="footer">© coding by Ammar Yasser & Mohamed ashraf Template designed by <a href="https://www.facebook.com/profile.php?id=100067037925992">GTP</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
