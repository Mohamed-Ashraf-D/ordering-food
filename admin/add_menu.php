					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO products(store_id,title,slogan,price,img) VALUE('".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['about']."','".$_POST['price']."','".$fnew."')";  // store the submited data ino the database :images
												$query=mysqli_query($db, $sql);
                                                if(!$query){
                                                    echo "Error       ssssssssssssss".mysqli_error($db);
                                                }
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from stores";
													...
													{
                                                       echo' <option value="'.$row['store_id'].'">'.$row['title'].'</option>';;
													}  
