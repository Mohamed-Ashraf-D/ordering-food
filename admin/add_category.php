...
if(isset($_POST['submit'] ))
{
	...
	$check_cat= mysqli_query($db, "SELECT c_name FROM categories where c_name = '".$_POST['c_name']."' ");
	...
	if(mysqli_num_rows($check_cat) > 0)
     {
        ...
        if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
        {
            if($fsize>=1000000)
            {
                ...
                $mql = "INSERT INTO categories(c_name,img) VALUES('".$_POST['c_name']."','".$fnew."')";
                $query=mysqli_query($db, $mql);
                ...
                if($query){
                    ...
                    echo "eeeeeeeeeeeeeeeeeeeeeeeee".mysqli_error($db);
                }
            }
        }
