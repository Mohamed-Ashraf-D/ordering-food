                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
                                ...
                                <a href="checkout.php"><p class="text-xs-center"> <input type="submit" onclick="checkout.php" name="submit"  class="btn btn-outline-success btn-block" value="Order now"> </p>
